      ...
      <div className="relative w-full max-w-md mx-auto">
        <div className="backdrop-blur-xl bg-black/40 p-8 rounded-2xl border border-gray-800">
          ...
          <form className="space-y-6">
            ...
            <button
              type="button"
              className="w-full border border-gray-800 text-white rounded-lg px-4 py-3 flex items-center justify-center space-x-2 hover:bg-gray-900 transition-colors"
            >
